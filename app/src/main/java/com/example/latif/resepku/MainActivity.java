package com.example.latif.resepku;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resep.add(new Resep("Orak Arik Sayuran","Orak Arik Sayuran adalah sebuah makanan berupa sayuran yang dicampur dengan berbagai bumbu-bumbu.", "1.Tomat \n2. Telur\n3. Bawang Putih\n4. Merica\n5. bawang putih\n6. bawang merah", "1.process"));
